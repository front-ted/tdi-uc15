...
$(document).ready(function () {
  ...
  function carregarProximaPergunta() {
    if (currentStep < steps.length) {
      ...
      $("#chat-input").empty();
      $("#chat-messages").append('<div class="message received">=D</div>');
      scrollToBottom();
    }
  }
                ...
                <div class="row container-whats">
                    <div class="col p-0 historico-conversas">
                        <div class="chat-history">
                            <h1 class="title-historico">DesignChat </h1><span class="icone-cam"><img src="assets/img/icon_cam.png" alt=""></span> <h1>:</h1>
                        </div>
                    ...
                    <div class="col p-0 hidden" id="coluna-whats">
                        <div class="chat-container">
                            <div class="chat-header">
                                ...
                                <span class="chat-title figtree">Consultoria com Valéria</span>
                            </div>
